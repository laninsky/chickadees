...
# (and outputs Fig 4, Table S5, and Fig S5)
...
ggsave(paste("FigS5A.png",sep=""),width=400,height=200,units="mm")
...
for (i in unique(reduced_combined$chromosome)) {
  ...
  if (length(unique(tempcombined$scaffolds))>1) {
    ...
    ggsave(paste("FigS5_alpha_chrom_",i,".png",sep=""),width=400,height=200,units="mm")
    ...
    ggsave(paste("FigS5_beta_chrom_",i,".png",sep=""),width=400,height=200,units="mm")
...
ggsave("FigS5B_positive_beta_by_total_markers.png",width=400,height=400,units="mm")
...
write_delim(output,"Table_S5_outlying_marker_blocks.txt")
...
write_delim(output,"Table_S5_outlying_marker_bed_format.bed",col_names = FALSE)
...
write_delim(output,"Table_S5_positive_beta_SNPs_bed_format.bed",col_names = FALSE)
...
write_delim(output,"Table_S5_positive_beta_SNPs.txt",col_names = TRUE)
...
#  [1] ggrepel_0.8.1     DescTools_0.99.39 gtable_0.3.0      forcats_0.4.0     stringr_1.4.0     dplyr_1.0.2       purrr_0.3.3       readr_1.3.1       tidyr_1.0.2      
#[10] tibble_3.0.4      ggplot2_3.3.2     tidyverse_1.3.0  
#
#loaded via a namespace (and not attached):
#  [1] tidyselect_1.1.0  haven_2.2.0       lattice_0.20-38   colorspace_1.4-1  vctrs_0.3.4       generics_0.1.0    expm_0.999-4      rlang_0.4.8       e1071_1.7-3      
#[10] pillar_1.4.3      glue_1.4.2        withr_2.1.2       DBI_1.1.0         dbplyr_1.4.2      modelr_0.1.5      readxl_1.3.1      rootSolve_1.8.2.1 lifecycle_0.2.0  
#[19] munsell_0.5.0     cellranger_1.1.0  rvest_0.3.5       mvtnorm_1.1-1     lmom_2.8          class_7.3-15      fansi_0.4.1       broom_0.7.2       Rcpp_1.0.4.6     
#[28] scales_1.1.0      backports_1.1.5   jsonlite_1.6.1    fs_1.3.1          gld_2.6.2         Exact_2.1         hms_0.5.3         stringi_1.4.5     cli_2.0.1        
#[37] tools_3.6.3       magrittr_1.5      crayon_1.3.4      pkgconfig_2.0.3   ellipsis_0.3.0    MASS_7.3-51.5     Matrix_1.2-18     xml2_1.2.2        reprex_0.3.0     
#[46] lubridate_1.7.4   assertthat_0.2.1  httr_1.4.1        rstudioapi_0.11   R6_2.4.1          boot_1.3-24       compiler_3.6.3 
